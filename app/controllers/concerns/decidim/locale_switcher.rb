...
# Overrides decidim-core/app/controllers/concerns/decidim/locale_switcher
# ensures default language comes from organization configuration
  ...
  module LocaleSwitcher
    ...
    included do
      ...
      def extract_locale_from_accept_language_header
        lang = request.env["HTTP_ACCEPT_LANGUAGE"] || default_locale
        lang.scan(/^[a-z\-A-Z]{5}|[a-z]{2}/).first
      end
    end
  end
end
